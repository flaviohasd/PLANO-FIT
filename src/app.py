...
if not st.session_state.logged_in:
    ...
    # >>>>>>>> ALTERAÇÃO AQUI <<<<<<<<<<
    # O bloco de código que verificava 'st.session_state.new_user_redirect' foi removido.
    # O menu agora sempre usará o índice 0 como padrão na primeira vez que for carregado,
    # ou o valor salvo em 'st.session_state.active_tab' se o usuário já navegou.
